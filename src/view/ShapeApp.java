...
public class ShapeApp extends JFrame {
    ...
    public void createMenue() {
        ...
        shapeController.createMenuItem(text, "Add text", e -> {
    ...
    private void createToolbox() {
        ...
        shapeController.createPanelButton(objectTools, "Red", e -> {
            this.color = Color.RED;
            shapeController.updateShapes(this);
        });
        shapeController.createPanelButton(objectTools, "Blue", e -> {
            this.color = Color.BLUE;
            shapeController.updateShapes(this);
        });
        shapeController.createPanelButton(objectTools, "-", e -> {
