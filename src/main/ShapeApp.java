...
public class ShapeApp extends JFrame
{
  ...
  public void createMenue()
  {
    ...
    shapeController.createMenuItem(addMenu, "Add marked shapes to custom tool", e ->
    ...
    shapeController.createMenuItem(addMenu, "Remove marked shapes to custom tool", e -> customShapes.removeAll());
